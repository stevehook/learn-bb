$(function() {
  ...
  window.ResourceView = Backbone.View.extend({
    ...
    refreshResource: function() {
      var html = this.model
        ? this.resourceTemplate({id: this.model.id, name: this.model.get('name'), data: this.model.get('data')})
        : '';
      $('#doc').html(html);
    },
    ...
    keydownTitle: function(e) {
      if (e.keyCode === 13) { e.preventDefault(); $('#docContent').focus(); }
    }
  });
});
